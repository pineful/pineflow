...
- `.github/workflows/deploy.yml`: main push 시 이미지를 빌드하고 GHCR에 발행하는 GitHub Actions workflow.
- `scripts/deploy-ec2.sh`: EC2가 스스로 GitHub/GHCR에서 pull해 app 컨테이너를 갱신하는 배포 스크립트.
